...
/**
 * A custom hook that returns the context for file uploading.
 *
 * @return {FileUploaderContextType} The context for file uploading
 */
export const useFileUpload = (): FileUploaderContextType => {
...
/**
 * A React component that renders a file uploader.
 *
  ...
  (
    ...
    const handleKeyDown = useCallback(
      (e: React.KeyboardEvent<HTMLDivElement>) => {
        ...
        /**
         * Moves the active index to the next item in the value array.
         *
         * @return {void}
         */
        const moveNext = (): void => {
        ...
        /**
         * Moves the active index to the previous index in the value array.
         *
         * @return {void}
         */
        const movePrev = (): void => {
        ...
        // Series of if statements that handle the keyboard events
        if (e.key === nextKey) {
          moveNext();
    ...
    const onDrop = useCallback(
      (acceptedFiles: File[], rejectedFiles: FileRejection[]) => {
        ...
        // If reSelectAll is true, remove all files from the array
        if (reSelectAll) {
        ...
        // If there are rejected files, show an error message
    ...
    useEffect(() => {
      if (!value) return;
      // Check if the value length is equal to the maxFiles
